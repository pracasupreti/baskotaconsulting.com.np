          ...
          <div class="row justify-content-center text-center">
            <div class="col-lg-7 col-md-12">
              ...
              <div class="animated3 mt-5">
                <a class="btn btn-2" href="contact.php"> <span class="btn-icon btn-arrow"></span>
                  <span class="btn-text">Contact Us</span>
                </a>
                <a class="btn btn-2 btn-border white" href="contact.php"> <span class="btn-icon btn-arrow"></span>
  ...
  <div class="container-fluid pr-sm-0">
    <div class="row">
      <div class="ml-auto mr-auto col-lg-3 col-md-12">
        ...
        <a class="btn btn-2" href="about.php">
